...
*
* Purpose: To producuce 16.2.1.2 Informed Consent
* Usage Notes: 
*
...
DATA ADSL;
SET adam.ADSL;
KEEP USUBJID RFICDT RFICDT_;
RFICDT_ = PUT(RFICDT, YYMMDD10.);
RUN;
...
FOOTNOTE1 J=L "E:\ROSHE\PROGRAMS\LIS2_AH_20221001.sas";

OPTIONS ORIENTATION=LANDSCAPE;
ODS ESCAPECHAR='^';
ODS RTF FILE = "E:\ROSHE30730\OUTPUTS\16_2_1_2.RTF" STYLE=styles.test;

PROC REPORT DATA = ADSL NOWD SPLOT="|" MISSING
STYLE = {OUTPUTWIDTH=100%} SPACING=1 WRAP
STYLE (HEADER) = [JUST=LEFT];

COLUMN USUBJID RFICDT_;

DEFINE USUBJID /DISPLAY "Subject Number"
STYLE (COLUMN) = [JUST=LEFT CELLWIDTH=10%];

DEFINE RFICDT_ /DISPLAY "Date of Informed Consent"
STYLE (COLUMN) = [JUST=LEFT CELLWIDTH=10%];
