...
* Program: tab1_3_AH_20221001.SAS  
*
...
%TABLE_POP_1(V1=ADSL_PK, V2=FINAL_PK, V3=PK Evaluable Population, V4=3, V5=ADSL_safety);
...
TITLE J=C "Table 14.1.3 Subject Assignment to Analysis Populations";

FOOTNOTE1 J=L "E:\ROSHE30730\PROGRAMS\tab1_3_AH_20221001.sas";
OPTIONS ORIENTATION=LANDSCAPE;
ODS ESCAPECHAR='^';

ODS RTF FILE = "E:\ROSHE30730\OUTPUTS\14_1_3.rtf" STYLE=styles.test;
